...
def prepare_data(df_path, output_dir="prepared_data", top_n_features=20, sample_size=200000, sampling_strategy='balanced', fast=False):
    ...
    "Impulse_Magnitude", "Impulse_Strength", "Impulse_Momentum",
    ...
    # 9. Recombine with target for sampling
    df_final = pd.concat([X_norm, df_lv['buy']], axis=1)

    # 10. Intelligent sampling
    ...
    # 12. Save splits and feature rankings
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        data_file = "monthly_AAPL_2024-12.csv"
